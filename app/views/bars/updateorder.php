...
<!-- Bar Item Details -->
            ...
            <div class="bar-bot-details-update-button"> 
              <a href="#roomplaceorder"><button type="submit">Update Order</button></a>
            </div>

            <div class="bar-bot-details-cancel-button"> 
              <a href="#roomplaceorder"><button type="submit">Cancel Order</button></a>
            </div><br>

            <div class="bar-bot-details-close-button"> 
              <a href="<?php echo URLROOT ?>/bars/barbill"><button type="submit">Close Order</button></a>
            </div>
            <br><br>
