...
<body>
  ...
  <div class="sys-wrapped-col">
    ...
    <!-- Add BOT item form-->
            <div>
            <h3 class="bot-add">Table No :</h3>
            <input type="text"  class = "bot-form-text" required>
                   
            <h3 class="bot-add">Order No :</h3>
            <input type="text"  class = "bot-form-text" required>
                   
            <div>
            <h3 class ="bot-add">BOT No :</h3>
            <input type="text"  class = "bot-form-text" required>
            </div>
            <br><br>
...
<!-- Send BOT Details -->
              <div>
              <h4 class="bot-details">BOT Details :</h4>
          ...
          <div class="BOT-snote">
              ...
              <textarea name="" id="" cols="30" rows="3"></textarea>
                ...
                <button type="submit" class="send-bot-button">Send the BOT</button>
                <br><br><br><br><br><br>
              </div>
    </div>
</div>
