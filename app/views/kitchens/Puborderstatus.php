...
<body>
  ...
  <div class="sys-right-col">
    <h5 class="Kitchen-orderlist2">Order No :<?php echo $_GET['barorderno']?></h5>
    ...
    <table class="Kitchen-table">
      ...
      <tr>
          ...
          <td><?php echo $orderitem->Volume?></td>
          <td><?php echo $orderitem->Quantity?></td>
      </tr>
      <?php endforeach; ?>
  </table><br><br>
  <form action="<?php echo URLROOT ?>/kitchens/Puborderstatus?barorderno=<?php echo $_GET['barorderno']?>" method="post">
