  ...
  <div class="sys-right-col">
    ...
    <div class="recep-reserv-form">
      ...
      <form action="recerve.php">
        ...
        <label for="checkin">Checke In:</label>
    ...
    <!-- KOT Item Details -->
            ...
            <div class="res-kot-details-update-button"> 
              <a href="#roomplaceorder"><button type="submit">Update Reservation</button></a>
            </div>

            <div class="res-kot-details-cancel-button"> 
              <a href="#roomplaceorder"><button type="submit">Cancel Reservation</button></a>
            </div><br>

            <div class="res-kot-details-close-button"> 
              <a href="<?php echo URLROOT ?>/reservations/roombill"><button type="submit">Close Reservation</button></a>
            </div>
            <br><br>
