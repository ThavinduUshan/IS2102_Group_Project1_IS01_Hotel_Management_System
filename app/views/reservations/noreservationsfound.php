...
<section class="register">
    ...
    <div class="error-page-container">
        ...
        <a href="<?php echo URLROOT ?>/reservations/selectdate"><button class="error-page-date" type="submit" name="submit">Look for another date</button></a>
        <a href="<?php echo URLROOT ?>/users/receptionist"><button class="error-back-home" type="submit" name="submit">Back to home</button></a>
        </div>  
     </div>
   <br><br><br>
  </section>
