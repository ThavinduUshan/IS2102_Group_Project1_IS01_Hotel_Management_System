...
<body>
  <section class="system">
    ...
    <form name="reportgenerate" method="post" action="<?php echo URLROOT; ?>/admins/reservationreports">
    <label for="sort">Sort By: </label>
      ...
      <select name="reporttype" id="reporttype">
        <option value="1">Popular Room Types</option>
        <option value="2">Popular Package Types</option>
        <option value="3">Popular Rooms</option>
      </select>
