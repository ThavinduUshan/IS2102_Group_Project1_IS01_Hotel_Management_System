...
<body>
  ...
  <div class="report-dashboard">
    ...
    <div class="rest-man-food">
      <table>
        <tr>
          <th style="width: 50%;">Complain Type</th>
          <th style="width: 50%;">No of Times Complained</th>
        </tr>
        <?php foreach($data['results'] as $result) : ?>
        <tr>
          <td style="width: 50%;"><?php echo $result->ComplainType?></td>
