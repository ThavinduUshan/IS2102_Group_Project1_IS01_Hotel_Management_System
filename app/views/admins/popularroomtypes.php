    ...
    <div class="rest-man-food">
      <table>
        <tr>
          ...
          <th style="width: 50%;">No of Times Booked</th>
        </tr>
        <?php foreach($data['results'] as $result) : ?>
        <tr>
          <?php if($result->PeopleCount == '1'){?>
            <td style="width: 50%;">Single Rooms</td>
          <?php
          }else if($result->PeopleCount == '2'){
          ?>
            <td style="width: 50%;">Double Rooms</td>
          <?php
          }else if($result->PeopleCount == '3'){
          ?>
            <td style="width: 50%;">Triple Rooms</td>
          <?php
          }else{
          ?>
          <td style="width: 50%;">NAN</td>
          <?php
            }
          ?>
