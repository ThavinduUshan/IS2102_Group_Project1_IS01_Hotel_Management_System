...
<body>
  <section class="system">
    ...
    <form name="reportgenerate" method="post" action="<?php echo URLROOT; ?>/admins/barreports">
    <label for="sort">Sort By: </label>
      ...
      <select name="reporttype" id="reporttype">
        <option value="1">Popular Bar Items</option>
        <option value="2">Popular Snack Items</option>
      </select>
